...
Matrix createLocalK(int e,mesh &m){
    ...
    float tau,kappa,lambda,delta,Ae,J,D;
    ...
    productRealMatrix(delta*Ae/(D*D),productMatrixMatrix(Betat,productMatrixMatrix(Alphat,productMatrixMatrix(Alpha,BPrima,2,2,3),2,2,3),6,2,3),matrixM);
